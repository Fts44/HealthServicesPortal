...
class StudentHealthRecordController extends Controller
{
    public function insert(Request $request, $id){
        ...
        $rules = [
            ...
            "shr_fathers_firstname" => ['required'],
            "shr_fathers_lastname" => ['required'],
            "shr_fathers_occupation" => ['required'],
            "shr_mothers_firstname" => ['required'],
            "shr_mothers_lastname" => ['required'],
        ...
        $message = [
            ...
            "shr_fathers_firstname.required" => 'Firstname is required!',
            "shr_fathers_lastname.required" => 'Lastname is required!',
            "shr_fathers_occupation.required" => 'Occupation is required!',
            "shr_mothers_firstname.required" => 'Firstname is required!',
            "shr_mothers_lastname.required" => 'Lastname is required!',
        ...
        if($validator->fails()){
            ...
            try{
                ...
                if($request->file('shr_profile_pic')){
                    $path = '/public/forms/shr/pictures/';
                ...
                $shr_id = DB::table("student_health_record")->insertGetId([
                    ...
                    "shr_emergency_firstname" => $request->shr_emergency_firstname,
                    "shr_emergency_middlename" => $request->shr_emergency_middlename,
                    "shr_emergency_lastname" => $request->shr_emergency_lastname,
                    "shr_emergency_suffixname" => $request->shr_emergency_suffixname,
                    ...
                    "shr_male_age_of_onset" => (($request->shr_gender=='male') ? $request->shr_female_menarche : NULL),
                    ...
                    "shr_fathers_firstname" => $request->shr_fathers_firstname,
                    "shr_fathers_middlename" => $request->shr_fathers_middlename,
                    "shr_fathers_lastname" => $request->shr_fathers_lastname,
                    "shr_fathers_suffixname" => $request->shr_fathers_suffixname,
                    "shr_fathers_occupation" => $request->shr_fathers_occupation,
                    "shr_mothers_firstname" => $request->shr_mothers_firstname,
                    "shr_mothers_middlename" => $request->shr_mothers_middlename,
                    "shr_mothers_lastname" => $request->shr_mothers_lastname,
                    "shr_mothers_suffixname" => $request->shr_mothers_suffixname,
