<div class="pagetitle mb-2">
    ...
    <div class="page-nav">
        <nav class="btn-group">   
            <a href="{{ route('AdminConfigurationInventoryEquipmentItem') }}" class="btn btn-sm btn-outline-primary {{(route('AdminConfigurationInventoryEquipmentItem')==url()->current()) ? 'active' : ''}}">Item</a>
